      ...
      case "art":
        if (subpage !== "undefined") {
          ...
          if (!isAlone && artistResult.copyright !== 2) {
            ...
            if (artResults.url_4) htmlContent += `<a href="/art/${artistResult.slug}?fromleonardo&id=${artResults.id}" class="appear-effect-very-fast-fadein inline-block" draggable="${draggable}"><img src="${artResults.url_4}" alt="${artResults.name + "_4"}" class="max-h-[100px] sm:max-h-[150px] md:max-h-[200px]" draggable="${draggable}"/></a>`;
            if (artResults.url_2) htmlContent += `<a href="/art/${artistResult.slug}?fromleonardo&id=${artResults.id}" class="appear-effect-very-fast-fadein inline-block" draggable="${draggable}"><img src="${artResults.url_2}" alt="${artResults.name + "_2"}" class="max-h-[100px] sm:max-h-[150px] md:max-h-[200px]" draggable="${draggable}"/></a>`;
            htmlContent += `<a href="/art/${artistResult.slug}?fromleonardo&id=${artResults.id}" class="appear-effect-very-fast-fadein inline-block" draggable="${draggable}"><img src="${artResults.url}" alt="${artResults.name}" class="max-h-[100px] sm:max-h-[150px] md:max-h-[200px]" draggable="${draggable}"/></a>`;
            if (artResults.url_3) htmlContent += `<a href="/art/${artistResult.slug}?fromleonardo&id=${artResults.id}" class="appear-effect-very-fast-fadein inline-block" draggable="${draggable}"><img src="${artResults.url_3}" alt="${artResults.name + "_3"}" class="max-h-[100px] sm:max-h-[150px] md:max-h-[200px]" draggable="${draggable}"/></a>`;
            if (artResults.url_5) htmlContent += `<a href="/art/${artistResult.slug}?fromleonardo&id=${artResults.id}" class="appear-effect-very-fast-fadein inline-block" draggable="${draggable}"><img src="${artResults.url_5}" alt="${artResults.name + "_5"}" class="max-h-[100px] sm:max-h-[150px] md:max-h-[200px]" draggable="${draggable}"/></a>`;
            htmlContent += `</div>`;
          }
