...
export const DELAY_API_CALL = 250;
...
export const DELAY_LEONARDO_CALL = DELAY_API_CALL;
...
export const DISCOVER_BANNER_ARTS: string[] = [
  "/arts/botticelli/La Naissance de Vénus.jpg",
  "/arts/courbet/L'Origine du monde.jpg",
  "/arts/dali/La Persistance de la mémoire.jpg",
  "/arts/david/Le Sacre de Napoléon.jpg",
  "/arts/degoya/Le Trois mai.jpg",
  "/arts/delacroix/La Liberté guidant le peuple.jpg",
  "/arts/detoulouselautrec/Au Moulin-Rouge.jpg",
  "/arts/devinci/La Joconde.jpg",
  "/arts/friedrich/Le Voyageur contemplant une mer de nuages.jpg",
  "/arts/gericault/Le Radeau de La Méduse.jpg",
  "/arts/hokusai/La Grande Vague de Kanagawa.jpg",
  "/arts/klimt/Le Baiser.jpg",
  "/arts/lecaravage/La Vocation de saint Matthieu.jpg",
  "/arts/manet/Le Déjeuner sur l'herbe.jpg",
  "/arts/mcneillwhistler/Arrangement en gris et noir n°1.jpg",
  "/arts/michelange/La Création d'Adam.jpg",
  "/arts/monet/Les Nymphéas.jpg",
  "/arts/munch/Cri.jpg",
  "/arts/rembrandt/La Ronde de nuit.jpg",
  "/arts/renoir/Bal du moulin de la Galette.jpg",
  "/arts/seurat/Un dimanche après-midi à l'Île de la Grande Jatte.jpg",
...
/**
 * Correspondance entre code pays ISO 3166-1 alpha-2 et slug
 */
export const COUNTRY_ALPHA2_TO_SLUG: Record<string, string> = {
  AM: "armenia",
  AT: "austria",
  BE: "belgium",
  BG: "bulgaria",
...
/**
 * Capitale principale par code pays ISO 3166-1 alpha-2 (en anglais et en français)
 */
export const COUNTRY_CAPITALS: Record<string, { en: string; fr: string }> = {
  AD: { en: "Andorra la Vella", fr: "Andorre-la-Vieille" },
  AE: { en: "Abu Dhabi", fr: "Abou Dabi" },
  AF: { en: "Kabul", fr: "Kaboul" },
  AG: { en: "Saint John's", fr: "Saint-Jean" },
  AI: { en: "The Valley", fr: "The Valley" },
  AL: { en: "Tirana", fr: "Tirana" },
  AM: { en: "Yerevan", fr: "Erevan" },
  AO: { en: "Luanda", fr: "Luanda" },
  AR: { en: "Buenos Aires", fr: "Buenos Aires" },
  AS: { en: "Pago Pago", fr: "Pago Pago" },
  AT: { en: "Vienna", fr: "Vienne" },
  AU: { en: "Canberra", fr: "Canberra" },
  AW: { en: "Oranjestad", fr: "Oranjestad" },
  AZ: { en: "Baku", fr: "Bakou" },
  BA: { en: "Sarajevo", fr: "Sarajevo" },
  BB: { en: "Bridgetown", fr: "Bridgetown" },
  BD: { en: "Dhaka", fr: "Dacca" },
  BE: { en: "Brussels", fr: "Bruxelles" },
  BF: { en: "Ouagadougou", fr: "Ouagadougou" },
  BG: { en: "Sofia", fr: "Sofia" },
  BH: { en: "Manama", fr: "Manama" },
  BI: { en: "Gitega", fr: "Gitega" },
  BJ: { en: "Porto-Novo", fr: "Porto-Novo" },
  BL: { en: "Gustavia", fr: "Gustavia" },
  BM: { en: "Hamilton", fr: "Hamilton" },
  BN: { en: "Bandar Seri Begawan", fr: "Bandar Seri Begawan" },
  BO: { en: "Sucre", fr: "Sucre" },
  BQ: { en: "Kralendijk", fr: "Kralendijk" },
  BR: { en: "Brasília", fr: "Brasília" },
  BS: { en: "Nassau", fr: "Nassau" },
  BT: { en: "Thimphu", fr: "Thimphou" },
  BW: { en: "Gaborone", fr: "Gaborone" },
  BY: { en: "Minsk", fr: "Minsk" },
  BZ: { en: "Belmopan", fr: "Belmopan" },
  CA: { en: "Ottawa", fr: "Ottawa" },
  CC: { en: "West Island", fr: "West Island" },
  CD: { en: "Kinshasa", fr: "Kinshasa" },
  CF: { en: "Bangui", fr: "Bangui" },
  CG: { en: "Brazzaville", fr: "Brazzaville" },
  CH: { en: "Bern", fr: "Berne" },
  CI: { en: "Yamoussoukro", fr: "Yamoussoukro" },
  CK: { en: "Avarua", fr: "Avarua" },
  CL: { en: "Santiago", fr: "Santiago" },
  CM: { en: "Yaoundé", fr: "Yaoundé" },
  CN: { en: "Beijing", fr: "Pékin" },
  CO: { en: "Bogotá", fr: "Bogotá" },
  CR: { en: "San José", fr: "San José" },
  CU: { en: "Havana", fr: "La Havane" },
  CV: { en: "Praia", fr: "Praia" },
  CW: { en: "Willemstad", fr: "Willemstad" },
  CX: { en: "Flying Fish Cove", fr: "Flying Fish Cove" },
  CY: { en: "Nicosia", fr: "Nicosie" },
  CZ: { en: "Prague", fr: "Prague" },
  DE: { en: "Berlin", fr: "Berlin" },
  DJ: { en: "Djibouti", fr: "Djibouti" },
  DK: { en: "Copenhagen", fr: "Copenhague" },
  DM: { en: "Roseau", fr: "Roseau" },
  DO: { en: "Santo Domingo", fr: "Saint-Domingue" },
  DZ: { en: "Algiers", fr: "Alger" },
  EC: { en: "Quito", fr: "Quito" },
  EE: { en: "Tallinn", fr: "Tallinn" },
  EG: { en: "Cairo", fr: "Le Caire" },
  EH: { en: "Laayoune", fr: "Laâyoune" },
  ER: { en: "Asmara", fr: "Asmara" },
  ES: { en: "Madrid", fr: "Madrid" },
  ET: { en: "Addis Ababa", fr: "Addis-Abeba" },
  FI: { en: "Helsinki", fr: "Helsinki" },
  FJ: { en: "Suva", fr: "Suva" },
  FK: { en: "Stanley", fr: "Stanley" },
  FM: { en: "Palikir", fr: "Palikir" },
  FO: { en: "Tórshavn", fr: "Tórshavn" },
  FR: { en: "Paris", fr: "Paris" },
  GA: { en: "Libreville", fr: "Libreville" },
  GB: { en: "London", fr: "Londres" },
  GD: { en: "Saint George's", fr: "Saint-Georges" },
  GE: { en: "Tbilisi", fr: "Tbilissi" },
  GF: { en: "Cayenne", fr: "Cayenne" },
  GG: { en: "Saint Peter Port", fr: "Saint-Pierre-Port" },
  GH: { en: "Accra", fr: "Accra" },
  GI: { en: "Gibraltar", fr: "Gibraltar" },
  GL: { en: "Nuuk", fr: "Nuuk" },
  GM: { en: "Banjul", fr: "Banjul" },
  GN: { en: "Conakry", fr: "Conakry" },
  GP: { en: "Basse-Terre", fr: "Basse-Terre" },
  GQ: { en: "Malabo", fr: "Malabo" },
  GR: { en: "Athens", fr: "Athènes" },
  GS: { en: "King Edward Point", fr: "King Edward Point" },
  GT: { en: "Guatemala City", fr: "Guatemala" },
  GU: { en: "Hagåtña", fr: "Hagåtña" },
  GW: { en: "Bissau", fr: "Bissau" },
  GY: { en: "Georgetown", fr: "Georgetown" },
  HK: { en: "Hong Kong", fr: "Hong Kong" },
  HN: { en: "Tegucigalpa", fr: "Tegucigalpa" },
  HR: { en: "Zagreb", fr: "Zagreb" },
  HT: { en: "Port-au-Prince", fr: "Port-au-Prince" },
  HU: { en: "Budapest", fr: "Budapest" },
  ID: { en: "Jakarta", fr: "Jakarta" },
  IE: { en: "Dublin", fr: "Dublin" },
  IL: { en: "Jerusalem", fr: "Jérusalem" },
  IM: { en: "Douglas", fr: "Douglas" },
  IN: { en: "New Delhi", fr: "New Delhi" },
  IO: { en: "Diego Garcia", fr: "Diego Garcia" },
  IQ: { en: "Baghdad", fr: "Bagdad" },
  IR: { en: "Tehran", fr: "Téhéran" },
  IS: { en: "Reykjavík", fr: "Reykjavik" },
  IT: { en: "Rome", fr: "Rome" },
  JE: { en: "Saint Helier", fr: "Saint-Hélier" },
  JM: { en: "Kingston", fr: "Kingston" },
  JO: { en: "Amman", fr: "Amman" },
  JP: { en: "Tokyo", fr: "Tokyo" },
  KE: { en: "Nairobi", fr: "Nairobi" },
  KG: { en: "Bishkek", fr: "Bichkek" },
  KH: { en: "Phnom Penh", fr: "Phnom Penh" },
  KI: { en: "South Tarawa", fr: "South Tarawa" },
  KM: { en: "Moroni", fr: "Moroni" },
  KN: { en: "Basseterre", fr: "Basseterre" },
  KP: { en: "Pyongyang", fr: "Pyongyang" },
  KR: { en: "Seoul", fr: "Séoul" },
  KW: { en: "Kuwait City", fr: "Koweït" },
  KY: { en: "George Town", fr: "George Town" },
  KZ: { en: "Astana", fr: "Astana" },
  LA: { en: "Vientiane", fr: "Vientiane" },
  LB: { en: "Beirut", fr: "Beyrouth" },
  LC: { en: "Castries", fr: "Castries" },
  LI: { en: "Vaduz", fr: "Vaduz" },
  LK: { en: "Sri Jayawardenepura Kotte", fr: "Sri Jayawardenepura Kotte" },
  LR: { en: "Monrovia", fr: "Monrovia" },
  LS: { en: "Maseru", fr: "Maseru" },
  LT: { en: "Vilnius", fr: "Vilnius" },
  LU: { en: "Luxembourg", fr: "Luxembourg" },
  LV: { en: "Riga", fr: "Riga" },
  LY: { en: "Tripoli", fr: "Tripoli" },
  MA: { en: "Rabat", fr: "Rabat" },
  MC: { en: "Monaco", fr: "Monaco" },
  MD: { en: "Chișinău", fr: "Chișinău" },
  ME: { en: "Podgorica", fr: "Podgorica" },
  MF: { en: "Marigot", fr: "Marigot" },
  MG: { en: "Antananarivo", fr: "Antananarivo" },
  MH: { en: "Majuro", fr: "Majuro" },
  MK: { en: "Skopje", fr: "Skopje" },
  ML: { en: "Bamako", fr: "Bamako" },
  MM: { en: "Naypyidaw", fr: "Naypyidaw" },
  MN: { en: "Ulaanbaatar", fr: "Oulan-Bator" },
  MO: { en: "Macao", fr: "Macao" },
  MP: { en: "Saipan", fr: "Saipan" },
  MQ: { en: "Fort-de-France", fr: "Fort-de-France" },
  MR: { en: "Nouakchott", fr: "Nouakchott" },
  MS: { en: "Plymouth", fr: "Plymouth" },
  MT: { en: "Valletta", fr: "La Valette" },
  MU: { en: "Port Louis", fr: "Port-Louis" },
  MV: { en: "Malé", fr: "Malé" },
  MW: { en: "Lilongwe", fr: "Lilongwe" },
  MX: { en: "Mexico City", fr: "Mexico" },
  MY: { en: "Kuala Lumpur", fr: "Kuala Lumpur" },
  MZ: { en: "Maputo", fr: "Maputo" },
  NA: { en: "Windhoek", fr: "Windhoek" },
  NC: { en: "Nouméa", fr: "Nouméa" },
  NE: { en: "Niamey", fr: "Niamey" },
  NF: { en: "Kingston", fr: "Kingston" },
  NG: { en: "Abuja", fr: "Abuja" },
  NI: { en: "Managua", fr: "Managua" },
  NL: { en: "Amsterdam", fr: "Amsterdam" },
  NO: { en: "Oslo", fr: "Oslo" },
  NP: { en: "Kathmandu", fr: "Katmandou" },
  NR: { en: "Yaren", fr: "Yaren" },
  NU: { en: "Alofi", fr: "Alofi" },
  NZ: { en: "Wellington", fr: "Wellington" },
  OM: { en: "Muscat", fr: "Mascate" },
  PA: { en: "Panama City", fr: "Panama" },
  PE: { en: "Lima", fr: "Lima" },
  PF: { en: "Papeete", fr: "Papeete" },
  PG: { en: "Port Moresby", fr: "Port Moresby" },
  PH: { en: "Manila", fr: "Manille" },
  PK: { en: "Islamabad", fr: "Islamabad" },
  PL: { en: "Warsaw", fr: "Varsovie" },
  PM: { en: "Saint-Pierre", fr: "Saint-Pierre" },
  PN: { en: "Adamstown", fr: "Adamstown" },
  PR: { en: "San Juan", fr: "San Juan" },
  PS: { en: "Ramallah", fr: "Ramallah" },
  PT: { en: "Lisbon", fr: "Lisbonne" },
  PW: { en: "Ngerulmud", fr: "Ngerulmud" },
  PY: { en: "Asunción", fr: "Asunción" },
  QA: { en: "Doha", fr: "Doha" },
  RE: { en: "Saint-Denis", fr: "Saint-Denis" },
  RO: { en: "Bucharest", fr: "Bucarest" },
  RS: { en: "Belgrade", fr: "Belgrade" },
  RU: { en: "Moscow", fr: "Moscou" },
  RW: { en: "Kigali", fr: "Kigali" },
  SA: { en: "Riyadh", fr: "Riyad" },
  SB: { en: "Honiara", fr: "Honiara" },
  SC: { en: "Victoria", fr: "Victoria" },
  SD: { en: "Khartoum", fr: "Khartoum" },
  SE: { en: "Stockholm", fr: "Stockholm" },
  SG: { en: "Singapore", fr: "Singapour" },
  SH: { en: "Jamestown", fr: "Jamestown" },
  SI: { en: "Ljubljana", fr: "Ljubljana" },
  SJ: { en: "Longyearbyen", fr: "Longyearbyen" },
  SK: { en: "Bratislava", fr: "Bratislava" },
  SL: { en: "Freetown", fr: "Freetown" },
  SM: { en: "San Marino", fr: "Saint-Marin" },
  SN: { en: "Dakar", fr: "Dakar" },
  SO: { en: "Mogadishu", fr: "Mogadiscio" },
  SR: { en: "Paramaribo", fr: "Paramaribo" },
  SS: { en: "Juba", fr: "Djouba" },
  ST: { en: "São Tomé", fr: "São Tomé" },
  SV: { en: "San Salvador", fr: "San Salvador" },
  SX: { en: "Philipsburg", fr: "Philipsburg" },
  SY: { en: "Damascus", fr: "Damas" },
  SZ: { en: "Mbabane", fr: "Mbabane" },
  TC: { en: "Cockburn Town", fr: "Cockburn Town" },
  TD: { en: "N'Djamena", fr: "N'Djaména" },
  TF: { en: "Port-aux-Français", fr: "Port-aux-Français" },
  TG: { en: "Lomé", fr: "Lomé" },
  TH: { en: "Bangkok", fr: "Bangkok" },
  TJ: { en: "Dushanbe", fr: "Douchanbé" },
  TK: { en: "Fakaofo", fr: "Fakaofo" },
  TL: { en: "Dili", fr: "Dili" },
  TM: { en: "Ashgabat", fr: "Achgabat" },
  TN: { en: "Tunis", fr: "Tunis" },
  TO: { en: "Nukuʻalofa", fr: "Nukuʻalofa" },
  TR: { en: "Ankara", fr: "Ankara" },
  TT: { en: "Port of Spain", fr: "Port-d'Espagne" },
  TV: { en: "Funafuti", fr: "Funafuti" },
  TW: { en: "Taipei", fr: "Taipei" },
  TZ: { en: "Dodoma", fr: "Dodoma" },
  UA: { en: "Kyiv", fr: "Kiev" },
  UG: { en: "Kampala", fr: "Kampala" },
  US: { en: "Washington, D.C.", fr: "Washington" },
  UY: { en: "Montevideo", fr: "Montevideo" },
  UZ: { en: "Tashkent", fr: "Tachkent" },
  VA: { en: "Vatican City", fr: "Cité du Vatican" },
  VC: { en: "Kingstown", fr: "Kingstown" },
  VE: { en: "Caracas", fr: "Caracas" },
  VG: { en: "Road Town", fr: "Road Town" },
  VI: { en: "Charlotte Amalie", fr: "Charlotte Amalie" },
  VN: { en: "Hanoi", fr: "Hanoï" },
  VU: { en: "Port Vila", fr: "Port-Vila" },
  WF: { en: "Mata-Utu", fr: "Mata-Utu" },
  WS: { en: "Apia", fr: "Apia" },
  XK: { en: "Pristina", fr: "Pristina" },
  YE: { en: "Sana'a", fr: "Sanaa" },
  YT: { en: "Mamoudzou", fr: "Mamoudzou" },
  ZA: { en: "Pretoria", fr: "Pretoria" },
  ZM: { en: "Lusaka", fr: "Lusaka" },
  ZW: { en: "Harare", fr: "Harare" },
};
