...
const translation = {
  ...
  leonardo: {
    ...
    artists_displayed: "Artists displayed for",
    arts_available: "artworks available",
    arts_currently_available: "artwork(s) are currently available.",
    ...
    discover_arts: "Discover other artworks by the same artist",
    from: "from",
    ...
    page_home_msg: `<p class="text-[1rem] leading-none">Click on the portrait of an artist to access their artworks.</p>`,
    ...
    page_women_msg: `<p class="text-[1rem] leading-none mt-1">Click on the portrait of an artist to access her artworks.</p>`,
    search_among: "Do your search among",
    unclassified_arts: "<h2>Here are the unclassified artworks.</h2>",
